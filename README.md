...
$$h(x) = R_{\mathcal{O}}(OFE(x), \mathcal{O}), \quad OFE: \mathcal{X} \to \mathbb{N}^{\mathcal{F}}, \quad R_{\mathcal{O}}: \mathbb{N}^{\mathcal{F}} \times \mathcal{O} \to \mathcal{Y},<br/> OFE(x)_{(P,C)} \in \mathbb{N}, \quad (P,C) \in \mathcal{F} \subseteq \mathcal{R} \times \mathcal{C},<br/> R_{\mathcal{O}}(OFE(x), \mathcal{O}) = \{\, y \in \mathcal{Y} \mid \mathcal{O} \models \Phi_y(OFE(x)) \,\},$$
